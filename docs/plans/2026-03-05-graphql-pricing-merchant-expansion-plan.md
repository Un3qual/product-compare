...
- [ ] Task 1: Add pricing read APIs in `ProductCompare.Pricing` for GraphQL resolver consumption.
- [ ] Task 2: Add GraphQL schema/resolver surface for merchant + merchant-product discovery.
