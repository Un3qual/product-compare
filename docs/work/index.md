...
moderation notes remain operator-only. Price watchlists and alerts are the next
coordinator planning target.

## Active Work

None while price watchlists and alerts are being planned.
