...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | needs_decision | Product data scraping | Choose the next CJ ingestion follow-up batch or explicitly defer further ingestion work. Do not choose CJ candidate CSV score export. | - | `docs/work/product-data-scraping.md`; `docs/work/index.md`; `docs/plans/INDEX.md` | Decision recorded in this queue and the lane work doc. | Exactly one concrete follow-up is promoted to `ready`, a named blocker is recorded, or ingestion work is explicitly deferred. |

## Ready Work

No `ready` rows exist. The Product data scraping lane needs one coordinator
decision before more implementation work is dispatched.
