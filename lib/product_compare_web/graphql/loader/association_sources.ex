defmodule ProductCompareWeb.GraphQL.Loader.AssociationSources do
  @moduledoc false
  ...
  alias ProductCompareSchemas.Specs.{
    ProductAttributeCurrent,
    SourceArtifact,
    SpecificationCorrection
  }

  @spec catalog(map()) :: Dataloader.Ecto.t()
  def catalog(params) do
    Dataloader.Ecto.new(Repo, query: &catalog_query/2, default_params: params)
  end

  @spec pricing(map()) :: Dataloader.Ecto.t()
  def pricing(params) do
