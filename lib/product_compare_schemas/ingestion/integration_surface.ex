defmodule ProductCompareSchemas.Ingestion.IntegrationSurface do
  ...
  @codes %{"shoppingProducts" => 1, "shoppingProductFeeds" => 2}

  @type t :: %__MODULE__{}

  schema "integration_surfaces" do
    field :code, :string
    field :name, :string
  ...
  def normalize_code(value), do: ReferenceCode.normalize(value, @codes, :none)
