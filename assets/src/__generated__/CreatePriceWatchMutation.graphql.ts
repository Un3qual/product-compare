/**
 * @generated SignedSource<<07da7020814acf7f43780bbbda5f4a2d>>
...
export type CreatePriceWatchMutation$variables = {
  input: CreatePriceWatchInput;
};
export type CreatePriceWatchMutation$data = {
...
export type CreatePriceWatchMutation = {
  response: CreatePriceWatchMutation$data;
  variables: CreatePriceWatchMutation$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "11dc2784c9e282475850f494ddc0b63a",
    "id": null,
    "metadata": {},
    "name": "CreatePriceWatchMutation",
    "operationKind": "mutation",
    "text": "mutation CreatePriceWatchMutation(\n  $input: CreatePriceWatchInput!\n) {\n  createPriceWatch(input: $input) {\n    watch {\n      id\n      productName\n      ruleType\n      currency\n      targetAmount\n      percentageDrop\n      enabled\n    }\n    errors {\n      code\n      field\n      message\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "be3211f91dd312aa225bcf67570bb521";
