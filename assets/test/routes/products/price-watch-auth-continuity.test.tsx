...
test("a mismatched product discards the draft and shows a normal empty form", async () => {
  writePendingIntent({
    kind: "price_watch",
    version: 1,
    expiresAt: Date.now() + 10 * 60_000,
...
function renderPriceWatch(viewer: null | { id: string; email: string; isOperator: boolean }) {
  return render(
