...
} from "../../../../src/routes/products/offers/product-offer-panel-data";
      ...
      edges: [
        {
          node: {
            ...
            currency: "USD",
            merchant: { id: "unsafe-merchant", name: "Unsafe Store" },
            latestPrice: null,
            activeCoupons: null,
            priceHistory: null,
          },
      ...
      edges: [
        {
          node: {
            ...
            currency: "USD",
            merchant: { id: "numeric-merchant", name: "Numeric Store" },
            latestPrice: {
        ...
        },
        {
          node: {
            ...
            currency: "USD",
            merchant: { id: "invalid-merchant", name: "Invalid Store" },
            latestPrice: {
              id: "invalid-price-point",
      ...
      edges: [
        {
          node: {
            ...
            url: "https://merchant.example.com/product",
            currency: "USD",
            merchant: { id: "merchant-acme", name: "Acme" },
            latestPrice: null,
            activeCoupons: {
              edges: [
                {
                ...
                },
                {
                  ...
                  node: {
                    code: "UNKNOWN",
                    description: null,
                    discountType: "%future added value",
                    discountValue: "10",
                    currency: "USD",
                    validTo: null,
                    terms: null,
      ...
      edges: [
        {
          node: {
            ...
            currency: "USD",
            merchant: { id: "merchant-us", name: "US Store" },
            latestPrice: {
              id: "usd-price-point",
        ...
        },
        {
          node: {
            ...
            currency: "CAD",
            merchant: { id: "merchant-ca", name: "Canada Store" },
            latestPrice: {
              id: "cad-price-point",
              observedAt: "2026-07-01T00:00:00Z",
              price: "9.00",
